                ...
                $main_content_last_part = "<div class='step'>
                                ...
                                <div class='ays-form-title'>{$form_title}</div>
                                    ...
                                    <div class='ays_buttons_div'>
                                        ...
                                        <input type='submit' name='ays_finish_quiz' class='" . ($enable_arrows ? 'ays_display_none' : '') . " ays_next ays_finish action-button' value='" . __('See Result', $this->plugin_name) . "'/>
                                    </div>
                                </div>
            ...
            if (!empty($question)) {
                ...
                if ($last) {
                    switch($options['informationForm']){
                        case "disable":
                            $input = "<i class='" . $buttons['nextArrow'] . " ays_fa ays_fa_flag_checkered ays_finish action-button ays_arrow ays_next_arrow'></i><input type='submit' name='ays_finish_quiz' class=' " . $buttons['nextButton'] . " ays_next ays_finish action-button' value='" . __('See Result', $this->plugin_name) . "'/>";
                            break;
                        case "before":
                            $input = "<i class='" . $buttons['nextArrow'] . " ays_fa ays_fa_flag_checkered ays_finish action-button ays_arrow ays_next_arrow'></i><input type='submit' name='ays_finish_quiz' class=' " . $buttons['nextButton'] . " ays_next ays_finish action-button' value='" . __('See Result', $this->plugin_name) . "'/>";
                            break;
                        case "after":
                            $input = "<i class='" . $buttons['nextArrow'] . " ays_fa ays_fa_arrow_right ays_finish action-button ays_arrow ays_next_arrow'></i><input type='button' name='next' class=' " . $buttons['nextButton'] . " ays_next action-button' value='" . __('Finish', $this->plugin_name) . "' />";
                            break;
                        default:
                            $input = "<i class='" . $buttons['nextArrow'] . " ays_fa ays_fa_flag_checkered ays_finish action-button ays_arrow ays_next_arrow'></i><input type='submit' name='ays_finish_quiz' class=' " . $buttons['nextButton'] . " ays_next ays_finish action-button' value='" . __('See Result', $this->plugin_name) . "'/>";
                            break;                        
