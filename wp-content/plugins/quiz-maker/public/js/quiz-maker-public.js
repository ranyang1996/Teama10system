        ...
        $(document).find('button.ays_check_answer').on('click', function (e) {
            ...
            if($(this).parent().find('.ays-text-input').val() !== ""){
                if ($(e.target).parents('form[id^="ays_finish_quiz"]').hasClass('enable_correction')) {
                    ...
                    let userAnsweredText = input.val().trim();
...
//                    next_fs.find('.ays-question-counter').addClass('shake');
        ...
        function aysResetQuiz ($quizContainer){
            $quizContainer.find('input[type="text"], textarea, input[type="number"], input[type="url"], input[type="email"]').each(function(){
                $(this).val('');
            });
            $quizContainer.find('select').each(function(){
                $(this).val('');
            });
            $quizContainer.find('select.ays-select').each(function(){
                $(this).val(null).trigger('change');
            });
            $quizContainer.find('select option').each(function(){
                $(this).removeAttr('selected');
            });
            $quizContainer.find('input[type="radio"], input[type="checkbox"]').each(function(){
